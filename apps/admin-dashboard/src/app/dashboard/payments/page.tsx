              ...
              {payments.length === 0 ? (
                ...
                payments.map(payment => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 font-medium rounded-full ${payment.plan === 'Enterprise' ? 'bg-white/[0.05] text-zinc-400' : 'bg-white/[0.05] text-zinc-400'}`}
                      >
                        {payment.plan}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center gap-1.5 px-2 py-1 font-medium rounded-full ${payment.status.toLowerCase() === 'completed' ? 'bg-white/[0.05] text-zinc-400' : payment.status.toLowerCase() === 'pending' ? 'bg-white/[0.05] text-zinc-400' : payment.status.toLowerCase() === 'failed' ? 'bg-white/[0.05] text-zinc-400' : 'bg-white/[0.04] text-zinc-500'}`}
                      >
