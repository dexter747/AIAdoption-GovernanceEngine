...
export default function SettingsPage() {
 ...
 >
 <div className={`w-5 h-5 bg-black rounded-full shadow transition-transform ${
 ...
 <p className="text-xs text-zinc-500 mb-3">Manage your API keys for third-party integrations</p>
 ...
 <p className="text-xs text-zinc-500 mb-3">Add an extra layer of security to admin accounts</p>
 <button className="px-3 py-1.5 text-xs font-medium text-zinc-300 border border-zinc-700 rounded-lg transition-colors hover:bg-white/[0.02]">
 Enable 2FA
 </button>
 </div>
