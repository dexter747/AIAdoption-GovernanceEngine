    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-500 mt-1">Manage your platform settings</p>
        </div>
        <button
          onClick={handleSave}
      ...
      <div className="flex gap-1 p-1 rounded-lg mb-6 w-fit bg-zinc-950">
        {tabs.map(tab => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md font-medium transition-colors ${activeTab === tab.id ? 'bg-black shadow-sm text-white' : 'text-zinc-500 hover:text-white'}`}
          >
      ...
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.02]">
        {activeTab === 'general' && (
          <div className="p-6 space-y-6">
            ...
            <div className="grid gap-6">
              <div>
                <label className="block font-medium mb-2 text-white">Site Name</label>
                <input
                  type="text"
                  value={settings.siteName}
                  onChange={e => setSettings({ ...settings, siteName: e.target.value })}
                  className="w-full max-w-md px-4 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-white/20 border border-white/[0.08] bg-black text-white"
                />
              </div>

              <div>
                <label className="block font-medium mb-2 text-white">Site Description</label>
                <textarea
              ...
              <div>
                <label className="block font-medium mb-2 text-white">Support Email</label>
                <input
                  type="email"
              ...
              <div className="flex items-center justify-between max-w-md">
                ...
                <button
                  onClick={() =>
                    setSettings({ ...settings, enableRegistration: !settings.enableRegistration })
                  }
                  className={`w-12 h-6 rounded-full transition-colors ${settings.enableRegistration ? 'bg-zinc-800' : 'bg-zinc-800'}`}
                >
                  <div
                    className={`w-5 h-5 bg-black rounded-full shadow transition-transform ${
            ...
            <div className="grid gap-6 max-w-md">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Master toggle for all notifications</p>
                </div>
                <button
                  onClick={() =>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Receive email when a new user registers</p>
                </div>
                <button
                  onClick={() =>
                    setSettings({ ...settings, emailOnNewUser: !settings.emailOnNewUser })
                  }
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Receive email for payment transactions</p>
                </div>
                <button
                  onClick={() =>
                    setSettings({ ...settings, emailOnPayment: !settings.emailOnPayment })
                  }
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Receive email when software is downloaded</p>
                </div>
                <button
                  onClick={() =>
                    setSettings({ ...settings, emailOnDownload: !settings.emailOnDownload })
                  }
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid gap-6">
              <div className="p-4 rounded-lg max-w-md bg-zinc-950">
                ...
                <button className="px-3 py-1.5 text-xs font-medium text-zinc-300 border border-zinc-700 rounded-lg transition-colors hover:bg-white/[0.02]">
                  Generate New Key
                </button>
              </div>
              ...
              <div className="p-4 rounded-lg max-w-md bg-zinc-950">
                ...
                <p className="text-xs text-zinc-500 mb-3">View and revoke active sessions</p>
                <button className="px-3 py-1.5 text-xs font-medium text-zinc-400 border border-zinc-700 rounded-lg transition-colors hover:bg-white/[0.02]">
                  Revoke All Sessions
                </button>
              </div>
            </div>
        ...
        {activeTab === 'billing' && (
          <div className="p-6 space-y-6">
            ...
            <div className="grid gap-6">
              <div>
                <label className="block font-medium mb-2 text-white">Stripe Publishable Key</label>
                <input
                  type="password"
              ...
              <div>
                <label className="block font-medium mb-2 text-white">Stripe Secret Key</label>
                <input
                  type="password"
              ...
              <div className="flex items-center justify-between max-w-md">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Enable Pro subscription tier</p>
                </div>
                <button
                  onClick={() =>
                    setSettings({ ...settings, enableProPlan: !settings.enableProPlan })
                  }
              ...
              <div>
                <label className="block font-medium mb-2 text-white">Pro Monthly Price ($)</label>
                <input
                  type="number"
                  value={settings.proMonthlyPrice}
                  onChange={e =>
                    setSettings({ ...settings, proMonthlyPrice: parseFloat(e.target.value) })
                  }
                  className="w-32 px-4 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-white/20 border border-white/[0.08] bg-black text-white"
                />
              </div>
              ...
              <div className="flex items-center justify-between max-w-md">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Enable Enterprise subscription tier</p>
                </div>
                <button
                  onClick={() =>
                    setSettings({
                      ...settings,
                      enableEnterprisePlan: !settings.enableEnterprisePlan,
                    })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setSettings({ ...settings, enterpriseMonthlyPrice: parseFloat(e.target.value) })
                  }
                  className="w-32 px-4 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-white/20 border border-white/[0.08] bg-black text-white"
                />
              </div>
