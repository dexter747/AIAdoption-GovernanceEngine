              ...
              {users.length === 0 ? (
                ...
                users.map(user => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 font-medium rounded-full ${user.status === 'Active' ? 'bg-white/[0.05] text-zinc-400' : user.status === 'Pending' ? 'bg-white/[0.05] text-zinc-400' : 'bg-white/[0.04] text-zinc-500'}`}
                      >
                        {user.status}
                      </span>
                    </td>
