...
export function SectionHeader({ badge, title, description, badgeColor = 'blue' }: SectionHeaderProps) {
  return (
    <div className="text-center mb-14">
      <span className={`inline-block px-3 py-1 rounded-md font-medium uppercase tracking-wider mb-4 ${badgeStyles[badgeColor]}`}>
        {badge}
      </span>
