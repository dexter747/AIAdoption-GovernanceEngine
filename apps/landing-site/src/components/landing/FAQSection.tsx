...
const faqs = [
 ...
 answer: "Absolutely! Velanova can connect to unlimited databases and systems simultaneously. Query across Oracle ERP, Salesforce CRM, and your data warehouse in a single natural language request. The AI understands context and automatically routes queries to the correct systems."
 },
 {
 question: "What kind of queries can I run?",
 answer: "Velanova handles everything from simple SELECT queries to complex multi-table joins, aggregations, and analytics. Ask questions like 'Show me customers who haven't purchased in 90 days' or 'What's our revenue trend by region?' The AI translates natural language into optimized SQL, REST API calls, or GraphQL queries depending on your system."
 },
 {
 question: "Do I need technical skills to use Velanova?",
 answer: "No! That's the beauty of Velanova. Business users can query enterprise systems using plain English. No SQL knowledge required. However, technical users can still write custom queries and use advanced features. The interface adapts to your skill level."
 },
 {
 question: "What happens if the AI query fails or produces wrong results?",
 answer: "Velanova includes built-in query validation and result verification. If a query might be ambiguous, the system asks for clarification before execution. You can always review the actual SQL/API calls being made. Plus, all queries are logged with full audit trails for compliance."
 },
 {
 ...
 {
 question: "Can Velanova handle compliance requirements (HIPAA, SOC 2, GDPR)?",
...
export default function FAQSection() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border mb-6 bg-blue-900/30 border-blue-800">
 ...
 key={index}
 value={`item-${index}`}
 className="faq-item rounded-xl px-6 border-none bg-gray-800/50"
 >
 <AccordionTrigger className="font-medium hover:no-underline text-white">
 {faq.question}
 </AccordionTrigger>
 ...
 <div className="rounded-2xl p-8 border bg-blue-900/20 border-blue-800">
 ...
 <a
 href="/docs"
 className="inline-flex items-center justify-center px-6 py-3 rounded-lg border-2 border-blue-600 text-blue-600 font-medium transition-colors hover:bg-blue-900/20"
 >
 View Documentation
 </a>
 </div>
