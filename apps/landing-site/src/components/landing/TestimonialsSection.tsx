...
const testimonials: Testimonial[] = [
  {
    quote:
      'Velanova transformed how our team accesses data. What used to take days now takes minutes. The ROI was immediate — we saved significant time each week in the first month alone.',
    author: 'Sarah Chen',
    role: 'VP of Engineering',
    company: 'TechCorp Global',
    avatar: 'SC',
    rating: 5,
    results: 'Dramatically faster access',
  },
  {
    quote:
  ...
  {
    quote:
      'The BYOK feature dramatically reduced our AI costs. We use our own OpenAI credits and have complete visibility into usage.',
    author: 'David Kim',
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="test-header text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-4xl md:text-5xl font-medium tracking-tight text-white mb-4">
            Built for <span className="text-shimmer">Enterprise Teams</span>
          </h2>
