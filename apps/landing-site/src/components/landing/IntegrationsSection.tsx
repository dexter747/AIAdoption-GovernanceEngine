...
const featured = [
  ...
  },
  {
    ...
    description: 'ERP & S/4HANA',
    color: 'from-zinc-900/60 to-transparent',
  },
  {
    name: 'Oracle',
    logo: '/legacy/oracle.svg',
    description: 'Database & EBS',
  ...
  },
  {
    ...
    color: 'from-cyan-950/30 to-transparent',
  },
  {
    name: 'HubSpot',
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex items-center justify-center gap-3 mb-14">
          ...
          <div className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/[0.06] bg-white/[0.02]">
            ...
            <span className="text-sm font-medium text-zinc-400">
              {totalCount - featured.length} more connectors across all categories
            </span>
          </div>
          <div className="h-px flex-1 bg-white/[0.04]" />
        </div>
        ...
        <div className="cat-grid flex flex-wrap justify-center gap-3 mb-10">
          {categorySummary.map(cat => (
            ...
            >
              ...
              <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-white/[0.06] text-zinc-500 group-hover:text-zinc-300 transition-colors">
                {cat.count}
              </span>
            </div>
          ))}
        ...
        <div className="integ-bottom text-center">
          <p className="mb-5 text-zinc-500">
            Don&apos;t see your system? We build custom connectors on request.
          </p>
          <a
            href="/integrations"
