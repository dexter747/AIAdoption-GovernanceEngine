...
export function FeaturesSection() {
 ...
 <Card 
 key={feature.title} 
 className="feature-card group relative transition-all duration-300 border-gray-800 hover:border-blue-500"
 >
 ...
 {/* Metric badge */}
 {feature.metric && (
 <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full font-medium bg-gray-900 text-gray-300">
