  ...
  return (
    <footer className="py-16 border-t bg-zinc-950 border-white/[0.06]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="footer-bottom pt-8 border-t flex flex-col gap-4 border-white/[0.06]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-2 border-t border-white/[0.04]">
            <div className="flex items-center gap-2 text-xs text-zinc-600">
              <span>Owned &amp; Operated by</span>
              <Image
                src="/astreus.png"
                alt="Astreus Next Gen"
                width={20}
                height={20}
                className="rounded"
              />
              <span className="text-zinc-500 font-medium">Astreus Next Gen</span>
            </div>
            <div className="hidden sm:block w-px h-4 bg-zinc-800" />
            <div className="flex items-center gap-2 text-xs text-zinc-600">
              <span>Developed &amp; Maintained By</span>
              <Image src="/nexolve.svg" alt="Nexolve Technologies" width={20} height={20} />
              <span className="text-zinc-500 font-medium">Nexolve Technologies</span>
            </div>
          </div>
        </div>
      </div>
