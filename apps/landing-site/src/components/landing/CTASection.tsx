...
export function CTASection() {
 ...
 {/* Headline */}
 <h2 className="md:text-6xl font-medium mb-6 leading-tight text-white">
 ...
 <Link
 href="/contact"
 className="px-8 py-4 rounded-xl transition-all font-medium inline-flex items-center justify-center gap-3 bg-gray-800 text-white hover:bg-gray-700 border-gray-700"
 >
 Talk to Sales
 </Link>
 </div>
