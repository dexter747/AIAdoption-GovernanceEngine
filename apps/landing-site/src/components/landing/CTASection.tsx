      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        <div className="cta-inner flex flex-col items-center">
          ...
          <p className="text-lg mb-10 max-w-2xl mx-auto leading-relaxed text-zinc-500">
            Transform your legacy systems with AI-powered queries. Unlock insights, automate
            workflows, and reclaim hours spent on manual data access.
          </p>
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-8">
            {['No credit card required', 'Deploy in under 5 minutes', 'Reliable & Secure'].map(
              text => (
