        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              AI Nexus (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our desktop application and related services (the &quot;Service&quot;).
            </p>
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">4. Legal Basis for Processing (GDPR)</h2>
            <p className="text-muted-foreground leading-relaxed">Under the GDPR, we process your data based on:</p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              To exercise these rights, contact us at <a href="mailto:privacy@ainexus.io" className="text-primary hover:underline">privacy@ainexus.io</a>
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We retain your personal data only for as long as necessary to fulfill the purposes outlined in this policy, unless a longer retention period is required by law. Account data is retained for the duration of your account plus 30 days after deletion request.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">8. International Data Transfers</h2>
            <p className="text-muted-foreground leading-relaxed">
              If we transfer data outside the EU/EEA, we ensure appropriate safeguards are in place, such as Standard Contractual Clauses (SCCs) or adequacy decisions.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">10. Children&apos;s Privacy</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">11. Changes to This Policy</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-muted/50 rounded-lg p-4 mt-4">
              <p className="text-foreground">AI Nexus Privacy Team</p>
              <p className="text-muted-foreground">Email: <a href="mailto:privacy@ainexus.io" className="text-primary hover:underline">privacy@ainexus.io</a></p>
