      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="bg-primary/10 border border-primary/20 rounded-lg p-6 mb-8">
          ...
          <p className="text-muted-foreground">
            We stand behind our product. If you&apos;re not satisfied with AI Nexus, we&apos;ll refund your purchase within 30 days of payment—no questions asked.
          </p>
        </div>
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">3. How to Request a Refund</h2>
            <div className="bg-muted/50 rounded-lg p-6">
              <ol className="list-decimal pl-6 text-muted-foreground space-y-4">
                <li>
                  <strong className="text-foreground">Email us</strong> at <a href="mailto:billing@ainexus.io" className="text-primary hover:underline">billing@ainexus.io</a> with subject line &quot;Refund Request&quot;
                </li>
                <li>
                ...
                <li>
                  <strong className="text-foreground">Wait for confirmation</strong> – We&apos;ll respond within 2 business days
                </li>
                <li>
                  <strong className="text-foreground">Receive your refund</strong> – Processed within 5-10 business days to your original payment method
                </li>
              </ol>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">4. Subscription Cancellation</h2>
            <p className="text-muted-foreground leading-relaxed">
              You can cancel your subscription at any time from your account settings or by contacting support. Upon cancellation:
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mt-4">
              ...
              <li>Features from the higher tier will be disabled at the end of the current period</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our 14-day free trial requires no payment information. You will only be charged if you:
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mt-4">
              <li>Explicitly upgrade to a paid plan during or after the trial</li>
              <li>Provide payment details and don&apos;t cancel before trial ends (if payment was required)</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">7. Currency and Payment Methods</h2>
            <p className="text-muted-foreground leading-relaxed">
              All prices are listed in USD. Refunds are issued in the original payment currency. Depending on your bank, currency conversion may result in slight differences from the original charge.
            </p>
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">8. Disputes and Chargebacks</h2>
            <p className="text-muted-foreground leading-relaxed">
              We encourage you to contact us before initiating a chargeback with your bank. Chargebacks take longer to resolve and may result in account suspension. We&apos;re happy to work with you directly to resolve any billing issues.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">9. Contact Billing Support</h2>
            <p className="text-muted-foreground leading-relaxed">
              For any billing questions or refund requests:
            </p>
            <div className="bg-muted/50 rounded-lg p-4 mt-4">
              <p className="text-foreground">AI Nexus Billing Team</p>
              <p className="text-muted-foreground">Email: <a href="mailto:billing@ainexus.io" className="text-primary hover:underline">billing@ainexus.io</a></p>
