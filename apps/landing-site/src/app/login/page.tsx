...
function LoginContent() {
 ...
 <div className="rounded-2xl shadow-lg p-8 md:p-12 w-full max-w-md bg-black border-gray-800">
 {/* Error Message */}
 {error && (
 <div className="mb-6 p-3 border rounded-lg bg-red-900/20 border-red-800">
 ...
 disabled={isLoading}
 className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed border-gray-800 hover:bg-gray-900"
 >
 ...
 <div className="pt-4 border-t text-center border-gray-800">
 <Link 
 href="/" 
