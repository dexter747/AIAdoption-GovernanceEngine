        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="order-2 lg:order-1">
            <div className="rounded-xl p-6 shadow-sm bg-zinc-900">
              <h2 className="font-medium mb-6 text-white">Order Summary</h2>

              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Plan</span>
                  <span className="font-medium text-white">{planNames[plan]}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Billing</span>
                  <span className="font-medium capitalize text-white">{cycle}</span>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-zinc-800">
                <h3 className="font-medium mb-4 text-white">What&apos;s included:</h3>
          ...
          <div className="order-1 lg:order-2">
            <div className="rounded-xl p-6 shadow-sm bg-zinc-900">
              <h2 className="font-medium mb-6 text-white">Payment Details</h2>

              {/* Dev Mode Notice */}
              <div className="mb-6 p-4 rounded-lg bg-zinc-900/30 border-zinc-800">
                <p className="text-zinc-400">
                  <strong>Development Mode:</strong> This is a mock checkout. No real payment will
                  be processed.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block font-medium mb-1 text-zinc-400">Email</label>
                  <input
                    type="email"
                    required
                ...
                <div>
                  <label className="block font-medium mb-1 text-zinc-400">Cardholder Name</label>
                  <input
                    type="text"
                    required
                    value={formData.name}
                ...
                <div>
                  <label className="block font-medium mb-1 text-zinc-400">Card Number</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block font-medium mb-1 text-zinc-400">Expiry</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block font-medium mb-1 text-zinc-400">CVC</label>
                    <input
                      type="text"
                      required
                      value={formData.cvc}
