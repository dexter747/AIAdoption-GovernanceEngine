...
export const metadata = {
  ...
  description: "Connect to 64+ enterprise systems. Pre-built connectors for databases, ERPs, CRMs, data warehouses, and more.",
};
...
const categories: Category[] = [
  {
    ...
    count: 14,
    integrations: [
      { name: "PostgreSQL", description: "Open-source relational DB", logo: "/legacy/postgresql.png" },
      ...
      { name: "Elasticsearch", description: "Search & analytics engine", logo: "/legacy/elasticsearch.svg" },
  ...
  },
  {
    ...
    integrations: [
      ...
      { name: "Microsoft Dynamics", description: "Business applications suite", logo: "/legacy/dynamics365.svg" },
    ],
  },
  {
    name: "CRM",
  ...
  },
  {
    ...
    integrations: [
      ...
      { name: "Amazon Redshift", description: "AWS petabyte-scale DW", logo: "/legacy/redshift.svg" },
      { name: "Databricks", description: "Unified analytics platform", logo: "/legacy/databricks.svg" },
  ...
  },
  {
    ...
    integrations: [
      ...
      { name: "SharePoint", description: "Microsoft collaboration", logo: "/legacy/sharepoint.svg" },
          ...
          <div className="mt-20 text-center">
            <div className="max-w-xl mx-auto p-8 rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              ...
              <p className="text-zinc-500 mb-6 text-sm">
                We build custom connectors on request. Our SDK also lets your team add any integration.
              </p>
