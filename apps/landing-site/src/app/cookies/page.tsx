    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">2. Types of Cookies We Use</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border border-border rounded-lg overflow-hidden">
                <thead className="bg-muted">
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-medium text-foreground">Cookie Name</th>
                ...
                <tbody className="divide-y divide-border">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm text-muted-foreground">Stores cookie preferences</td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm text-muted-foreground">1 year</td>
                    <td className="px-4 py-3 text-sm text-muted-foreground">Light/dark mode preference</td>
                  </tr>
                  <tr>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              When you first visit our site, you&apos;ll see a cookie banner where you can accept or reject non-essential cookies.
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Some browsers have a &quot;Do Not Track&quot; feature that signals to websites that you don&apos;t want your online activity tracked. We currently respond to DNT signals by disabling analytics cookies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The AI Nexus desktop application does not use cookies. However, it may store local preferences and authentication tokens in secure local storage on your device.
            </p>
          </section>
