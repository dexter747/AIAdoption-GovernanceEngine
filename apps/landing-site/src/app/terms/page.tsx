        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using AI Nexus (the &quot;Service&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you disagree with any part of these terms, you may not access the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              AI Nexus is a desktop application that enables users to connect their databases and enterprise systems to various AI models for natural language querying and data analysis. The Service includes:
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">To use certain features of the Service, you must:</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mt-4">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mt-4">
              ...
              <li>Use the Service to compete with AI Nexus</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">6. Subscription and Payments</h2>
            
            <h3 className="text-lg font-medium text-foreground mt-6 mb-3">6.1 Pricing</h3>
            <p className="text-muted-foreground leading-relaxed">
              Subscription fees are as listed on our pricing page. We reserve the right to change prices with 30 days&apos; notice.
            </p>

            <h3 className="text-lg font-medium text-foreground mt-6 mb-3">6.2 Billing</h3>
            <p className="text-muted-foreground leading-relaxed">
              Subscriptions are billed in advance on a monthly or annual basis. All fees are non-refundable except as stated in our Refund Policy.
            </p>

            <h3 className="text-lg font-medium text-foreground mt-6 mb-3">6.3 Free Trial</h3>
            <p className="text-muted-foreground leading-relaxed">
              We may offer free trials. If you don&apos;t cancel before the trial ends, you will be charged the applicable subscription fee.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The Service and its original content, features, and functionality are owned by AI Nexus and are protected by international copyright, trademark, and other intellectual property laws.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
          ...
          <section>
            <h2 className="text-2xl font-medium text-foreground mb-4">9. Disclaimer of Warranties</h2>
            <div className="bg-muted/50 rounded-lg p-4">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                AI-GENERATED OUTPUTS MAY CONTAIN ERRORS OR INACCURACIES. YOU ARE RESPONSIBLE FOR VERIFYING ALL OUTPUTS BEFORE RELYING ON THEM.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, AI NEXUS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              You agree to indemnify and hold harmless AI Nexus from any claims arising from your use of the Service, violation of these Terms, or infringement of any third-party rights.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We may terminate or suspend your access immediately, without prior notice, for any breach of these Terms. Upon termination:
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mt-4">
          ...
          <section>
            ...
            <div className="bg-muted/50 rounded-lg p-4 mt-4">
              <p className="text-foreground">AI Nexus Legal Team</p>
              <p className="text-muted-foreground">Email: <a href="mailto:legal@ainexus.io" className="text-primary hover:underline">legal@ainexus.io</a></p>
