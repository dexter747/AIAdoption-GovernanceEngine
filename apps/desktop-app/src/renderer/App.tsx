...
const PageFallback = memo(() => (
  <div className="flex-1 flex items-center justify-center">
    <div
      ...
      style={{
        border: '1.5px solid var(--login-spinner-track)',
        borderTopColor: 'var(--login-spinner-head)',
      }}
    />
  </div>
));
  ...
  return (
    ...
    >
      <div className="relative">
        <div
          className="absolute inset-0 rounded-xl blur-lg scale-125 animate-pulse"
