    ...
    return (
      <div className="space-y-2">
        <div className="flex items-center gap-2 text-sm text-zinc-500">
          <div className="animate-spin rounded-full h-4 w-4 border-2 border-zinc-700 border-t-blue-500"></div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className="mt-2 text-xs text-zinc-400 hover:text-zinc-500 underline"
              >
                Try again
              </button>
            </div>
