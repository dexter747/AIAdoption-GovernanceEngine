...
export default function SettingsPage() {
 ...
 className="w-full px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-900 border-gray-800 text-white"
 >
 ...
 className={`w-12 h-6 rounded-full transition-colors ${ settings.autoConnect ? 'bg-blue-500' : 'bg-gray-700'}`}
 >
 ...
 className={`w-12 h-6 rounded-full transition-colors ${ settings.saveHistory ? 'bg-blue-500' : 'bg-gray-700'}`}
 >
 <div className={`w-5 h-5 bg-background rounded-full shadow transition-transform ${
 ...
 placeholder="sk-..."
 className="w-full px-4 py-2 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-900 border-gray-800 text-white"
 />
 ...
 className={`w-12 h-6 rounded-full transition-colors ${ settings.notifications ? 'bg-blue-500' : 'bg-gray-700'}`}
 >
 <div className={`w-5 h-5 bg-background rounded-full shadow transition-transform ${
 ...
 className={`w-12 h-6 rounded-full transition-colors ${ settings.soundEffects ? 'bg-blue-500' : 'bg-gray-700'}`}
 >
 <div className={`w-5 h-5 bg-background rounded-full shadow transition-transform ${
 ...
 <button className="w-full text-left p-4 rounded-lg transition-colors bg-gray-900 hover:bg-gray-800">
