...
export default function LoginPage() {
 ...
 {/* Login Card */}
 <div className="backdrop-blur-xl rounded-3xl p-10 shadow-2xl bg-gray-900/80 border-gray-700/50">
 ...
 onClick={login}
 disabled={isLoading}
 className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-blue-500 text-white font-medium text-lg rounded-2xl hover:bg-blue-600 transition-all duration-200 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0"
 >
 {isLoading ? (
 <>
 ...
 <div className="inline-flex items-center justify-center w-14 h-14 backdrop-blur-lg rounded-2xl mb-3 group-hover:scale-110 transition-transform duration-200 shadow-lg bg-gray-800/60 border-gray-700/50">
 <Database className="w-7 h-7 text-blue-400" />
 </div>
 <p className="font-medium text-gray-300">Connect Databases</p>
 ...
 <p className="font-medium text-gray-300">AI-Powered</p>
 ...
 <p className="font-medium text-gray-300">Secure</p>
