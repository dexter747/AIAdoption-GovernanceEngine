...
export default function LicenseActivationPage() {
  const { license, isLoading, isValid, isPro, daysRemaining, activateLicense, deactivateLicense } =
    useLicense();
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="toolbar app-region-drag">
        ...
        <h1 className="ml-2 text-[13px] font-medium text-white/80 app-region-no-drag select-none">
          License
        </h1>
        {isValid && license && (
          <>
            ...
            <span
              className={`text-[10px] font-medium px-2 py-0.5 rounded-full border flex items-center gap-1 app-region-no-drag capitalize ${
              ...
              <div className="space-y-2 text-[12px]">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/50">
                    {license.activeMachines} /{' '}
                    {license.maxMachines === -1 ? '∞' : license.maxMachines}
                  </span>
                </div>
              </div>
              ...
              <div className="mt-3 flex items-center gap-3 px-4 py-3 rounded-lg border border-white/[0.06] bg-white/[0.015]">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10.5px] text-white/30">
                    Unlock all AI providers, MCP, and advanced features.
                  </p>
                </div>
                <button
                  onClick={() =>
                    window.electron?.system.openExternal('https://velanova.ai/pricing')
                  }
              ...
              <div className="flex items-start gap-3 px-4 py-3 rounded-lg border border-white/[0.06] bg-white/[0.015]">
                ...
                <div>
                  ...
                  <p className="text-[10.5px] text-white/30 mt-0.5">
                    Use Velanova with limited features, or
                    <button
                      onClick={() =>
                        window.electron?.system.openExternal('https://velanova.ai/pricing')
                      }
                      className="ml-1 text-white/40 hover:text-white/60 underline underline-offset-2 transition-colors"
                    >
                      purchase a license
                    </button>
                  </p>
