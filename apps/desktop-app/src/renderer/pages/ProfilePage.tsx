...
export default function ProfilePage() {
  ...
  return (
    <div className="p-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-medium text-black dark:text-white">Profile</h1>
      ...
      <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl p-6 mb-6">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h2 className="text-xl font-medium text-black dark:text-white">{user?.name || 'User'}</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl p-6">
          <h3 className="text-lg font-medium text-black dark:text-white mb-4">Account Details</h3>
        ...
        <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl p-6">
          <h3 className="text-lg font-medium text-black dark:text-white mb-4">Subscription</h3>
      ...
      <div className="mt-6 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl p-6">
        <h3 className="text-lg font-medium text-black dark:text-white mb-4">Security</h3>
