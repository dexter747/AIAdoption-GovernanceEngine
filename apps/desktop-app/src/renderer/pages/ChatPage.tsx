                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 mt-3 text-xs opacity-60">
                        ...
                        {message.cost && message.cost > 0 && (
                          <>
                            <span>•</span>
                            <span className="text-zinc-400">{formatCost(message.cost)}</span>
                          </>
                        )}
                      </div>
                    </div>
            ...
            <div className="flex gap-3">
              <div className="flex-1 relative group">
                <textarea
                  ...
                  disabled={isLoading}
                  rows={1}
                  className="w-full px-5 py-4 bg-white/[0.05] hover:bg-white/[0.08] focus:bg-white/[0.08] border border-white/10 focus:border-white/20 rounded-3xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-600/40 resize-none max-h-40 disabled:opacity-50 transition-all duration-200 backdrop-blur-xl shadow-xl"
                />
              ...
              <button
                ...
                className="px-6 py-4 bg-gradient-to-r from-zinc-400 to-zinc-600 hover:from-zinc-300 hover:to-zinc-700 disabled:from-gray-700 disabled:to-gray-800 disabled:cursor-not-allowed text-white rounded-3xl font-medium transition-all duration-200 flex items-center gap-2 shadow-lg shadow-white/5 hover:shadow-white/10 disabled:shadow-none group relative overflow-hidden"
              >
