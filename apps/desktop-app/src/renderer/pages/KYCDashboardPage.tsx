...
const MOCK_CLIENTS: Client[] = [
  {
    id: 'c1',
    name: 'Le Masurier Holdings Ltd',
    entity_type: 'corporate',
    jurisdiction: 'JE',
    email: 'compliance@lemasurier.je',
    risk_rating: 'standard',
    overall_risk_score: 28,
    status: 'active',
    pep_status: false,
    industry: 'Real Estate',
    source_of_wealth: 'Property Development',
    created_at: '2025-06-15T10:00:00Z',
  },
  {
    id: 'c2',
    name: 'Sir Philip Bailhache Trust',
    entity_type: 'trust',
    jurisdiction: 'JE',
    email: 'admin@jftrust.je',
    risk_rating: 'enhanced',
    overall_risk_score: 62,
    status: 'active',
    pep_status: true,
    industry: 'Legal Services',
    source_of_wealth: 'Professional Fees & Investments',
    created_at: '2025-04-20T09:30:00Z',
  },
  {
    id: 'c3',
    name: 'St Helier Capital Partners',
    entity_type: 'corporate',
    jurisdiction: 'JE',
    email: 'ops@stheliercapital.je',
    risk_rating: 'standard',
    overall_risk_score: 22,
    status: 'active',
    pep_status: false,
    industry: 'Fund Administration',
    source_of_wealth: 'Management Fees',
    created_at: '2025-08-10T14:00:00Z',
  },
  {
    id: 'c4',
    name: 'Grouville Marine Trading Ltd',
    entity_type: 'corporate',
    jurisdiction: 'JE',
    email: 'info@grouvillemarine.je',
    risk_rating: 'enhanced',
    overall_risk_score: 55,
    status: 'onboarding',
    pep_status: false,
    industry: 'Maritime Trade',
    source_of_wealth: 'Import/Export',
    created_at: '2026-01-22T11:00:00Z',
  },
  {
    id: 'c5',
    name: 'Catherine de Carteret',
    entity_type: 'individual',
    jurisdiction: 'JE',
    email: 'c.decarteret@gmail.com',
    risk_rating: 'low',
    overall_risk_score: 12,
    status: 'active',
    pep_status: false,
    industry: 'Retired',
    source_of_wealth: 'Pension & Savings',
    created_at: '2025-09-05T16:00:00Z',
  },
  {
    id: 'c6',
    name: 'Channel Islands Wealth Management',
    entity_type: 'corporate',
    jurisdiction: 'JE',
    email: 'kyc@ciwm.je',
    risk_rating: 'standard',
    ...
    source_of_wealth: 'Advisory Fees',
  ...
  },
  {
    ...
    pep_status: false,
    industry: 'Energy',
    source_of_wealth: 'Oil & Gas Holdings',
    created_at: '2024-11-20T10:00:00Z',
  },
  {
    id: 'c8',
    name: 'Gorey Harbour Developments',
    entity_type: 'corporate',
    jurisdiction: 'JE',
    email: 'dev@goreyharbour.je',
    risk_rating: 'low',
    overall_risk_score: 15,
    status: 'onboarding',
    pep_status: false,
    industry: 'Property Development',
    source_of_wealth: 'Construction Revenue',
    created_at: '2026-02-18T13:00:00Z',
  },
  {
    id: 'c9',
    name: 'Gulf Investment Holdings FZE',
    entity_type: 'corporate',
    jurisdiction: 'AE',
    email: 'compliance@gulfih.ae',
    risk_rating: 'enhanced',
  ...
  {
    id: 'c10',
    name: 'La Corbi\u00e8re Fund Services',
    entity_type: 'corporate',
    jurisdiction: 'JE',
    email: 'admin@lacorbiere.je',
    risk_rating: 'standard',
    overall_risk_score: 25,
    status: 'active',
    pep_status: false,
    industry: 'Fund Services',
    source_of_wealth: 'Fund Administration Fees',
    created_at: '2025-05-30T15:00:00Z',
  },
  {
    id: 'c11',
    name: 'Hon. James Saunders',
    entity_type: 'individual',
    jurisdiction: 'JE',
    email: 'j.saunders@states.je',
    risk_rating: 'pep',
    overall_risk_score: 71,
    status: 'active',
    pep_status: true,
    industry: 'Government',
    source_of_wealth: 'Public Service & Investments',
    created_at: '2025-01-15T11:00:00Z',
  },
  {
    id: 'c12',
    name: 'Trinity Bay Shipping Co',
    entity_type: 'corporate',
    jurisdiction: 'JE',
    email: 'ops@trinitybay.je',
    risk_rating: 'standard',
    overall_risk_score: 34,
    status: 'prospect',
    pep_status: false,
    industry: 'Shipping',
    source_of_wealth: 'Freight Revenue',
...
const MOCK_CHECKS: Check[] = [
  {
    ...
    status: 'passed',
    ai_assessment:
      'Identity verified via Jersey passport. Name match confirmed against electoral register.',
    ai_risk_flags: [],
    ai_confidence: 98,
  ...
  },
  {
    ...
    status: 'passed',
    ai_assessment: 'No sanctions matches found across OFAC, EU, UN and JFSC lists.',
    ai_risk_flags: [],
    ai_confidence: 99,
    completed_at: '2026-01-20T14:05:00Z',
    created_at: '2026-01-20T14:00:00Z',
  },
  {
    id: 'ch3',
    ...
    status: 'needs_review',
    ai_assessment:
      'Potential PEP match \u2014 States of Jersey Assembly member. Requires enhanced due diligence under JFSC Handbook.',
    ai_risk_flags: ['pep_match', 'enhanced_dd_required'],
    ai_confidence: 87,
    created_at: '2026-01-20T14:00:00Z',
  },
  {
    ...
    status: 'passed',
    ai_assessment:
      'No adverse media identified. Positive coverage in Jersey Evening Post regarding community involvement.',
    ai_risk_flags: [],
    ai_confidence: 92,
  ...
  {
    id: 'ch5',
    check_type: 'source_of_wealth',
    status: 'in_progress',
    ai_assessment:
      'Source of wealth documentation submitted. Reviewing property valuations and historic tax filings with Comptroller of Revenue.',
    ai_risk_flags: ['documentation_pending'],
    ai_confidence: 65,
    created_at: '2026-01-20T14:00:00Z',
  },
  {
    ...
    status: 'failed',
    ai_assessment:
      'Ultimate beneficial ownership unclear. Nominee shareholder structure in BVI \u2014 requires look-through analysis per JFSC guidance.',
    ai_risk_flags: ['opaque_structure', 'offshore_nominee', 'jfsc_flag'],
    ai_confidence: 78,
  ...
  },
  {
    ...
    status: 'passed',
    ai_assessment:
      'Jersey residential address confirmed via utility bill verification. Parish: St Helier.',
    ai_risk_flags: [],
    ai_confidence: 96,
...
const MOCK_DOCS: Doc[] = [
  {
    ...
    file_name: 'jersey_passport_scan.pdf',
    status: 'verified',
    ai_extracted_data: {
      name: 'Catherine de Carteret',
      dob: '1965-04-12',
    ...
    ai_verification_result: { valid: true, confidence: 97 },
    created_at: '2025-09-05T16:10:00Z',
  },
  {
    id: 'd2',
    document_type: 'utility_bill',
    file_name: 'jec_electricity_bill.pdf',
    status: 'verified',
    ai_extracted_data: {
      provider: 'Jersey Electricity',
      address: '14 La Route de St Aubin, St Helier, JE2 3SE',
    },
    ai_verification_result: { valid: true, confidence: 94 },
    created_at: '2025-09-05T16:15:00Z',
  },
  {
    id: 'd3',
    document_type: 'certificate_of_incorporation',
    file_name: 'grouville_marine_coi.pdf',
    status: 'pending',
    ai_extracted_data: {
      company: 'Grouville Marine Trading Ltd',
      registration: 'JFSC Reg #128456',
      date: '2018-03-22',
    },
  ...
  },
  {
    ...
    file_name: 'petrov_tax_declaration.pdf',
    status: 'rejected',
    ai_extracted_data: { name: 'Viktor Petrov', year: 2024 },
    ai_verification_result: {
      valid: false,
      reason: 'Document appears altered \u2014 metadata inconsistencies detected',
    },
  ...
  },
  {
    ...
    file_name: 'rbsi_bank_reference.pdf',
    status: 'verified',
    ai_extracted_data: {
      bank: 'RBS International (Jersey)',
      account_holder: 'St Helier Capital Partners',
    },
    ai_verification_result: { valid: true, confidence: 96 },
...
const MOCK_WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      { name: 'Identity Verification' },
      { name: 'PEP Screening' },
      { name: 'Source of Wealth Review' },
      { name: 'Enhanced Due Diligence' },
      { name: 'JFSC Notification' },
      { name: 'MLRO Sign-off' },
      { name: 'Board Approval' },
    ],
    completion_pct: 43,
...
const RISK_BG: Record<string, string> = {
  ...
  standard: 'bg-blue-900/20 text-blue-400',
  enhanced: 'bg-amber-900/20 text-amber-400',
  high: 'bg-red-900/20 text-red-400',
  pep: 'bg-purple-900/20 text-purple-400',
};
const STATUS_BG: Record<string, string> = {
  prospect: 'bg-zinc-800 text-zinc-400',
  onboarding: 'bg-blue-900/30 text-blue-400',
  active: 'bg-emerald-900/30 text-emerald-400',
  suspended: 'bg-red-900/30 text-red-400',
  offboarded: 'bg-zinc-800 text-zinc-600',
};
const CHECK_IC: Record<string, string> = {
  ...
  const assessRisk = () => {
    ...
    setRiskResult({
      ...
      summary:
        ...
        selected.name +
        ' reviewed against JFSC AML/CFT Handbook requirements. Entity type: ' +
        selected.entity_type +
        ', Jurisdiction: ' +
        selected.jurisdiction +
        '. ' +
        (selected.pep_status
          ? 'PEP-flagged \u2014 enhanced due diligence applied.'
          : 'Standard due diligence applicable.'),
      factors: [
        {
          factor: 'Jurisdiction Risk',
          detail:
            selected.jurisdiction === 'JE'
              ? 'Low \u2014 Jersey is MONEYVAL compliant jurisdiction'
              : selected.jurisdiction === 'RU'
                ? 'Critical \u2014 Sanctioned jurisdiction'
                : 'Medium \u2014 Requires enhanced monitoring',
          impact: selected.jurisdiction === 'RU' ? 'high' : 'low',
        },
        {
          factor: 'Entity Structure',
          detail:
            selected.entity_type === 'trust'
              ? 'Enhanced \u2014 Trust structures require UBO look-through'
              : 'Standard complexity',
          impact: selected.entity_type === 'trust' ? 'medium' : 'low',
        },
        {
          factor: 'PEP Status',
          detail: selected.pep_status
            ? 'PEP identified \u2014 JFSC enhanced monitoring requirements apply'
            : 'No PEP connections identified',
          impact: selected.pep_status ? 'high' : 'low',
        },
        {
          factor: 'Transaction Profile',
          detail: 'Transaction patterns consistent with declared business activity',
          impact: 'low',
        },
      ],
      missingChecks:
        selected.risk_rating === 'high' ? ['enhanced_due_diligence', 'source_of_funds'] : [],
      recommendations: [
        'Schedule periodic review per JFSC risk-based approach',
        selected.pep_status
          ? 'Maintain enhanced monitoring \u2014 quarterly PEP re-screening required'
          : 'Annual KYC refresh sufficient',
    ...
    setClients(prev => [
      {
        ...
        pep_status: false,
        industry: 'Other',
        source_of_wealth: 'To be assessed',
    ...
    sections: [
      {
        ...
        stats: [
          ...
          { label: 'Active', value: String(dash.byStatus.active || 0) },
          {
            ...
            value: String(dash.checksPending),
            change: dash.checksFailed + ' failed',
          },
      ...
      {
        type: 'table',
        columns: ['Name', 'Type', 'Jurisdiction', 'Risk', 'Status', 'PEP'],
        rows: clients.map(c => [
          c.name,
          c.entity_type,
          c.jurisdiction,
      ...
      {
        type: 'table',
        columns: ['Type', 'Status', 'AI Confidence', 'Risk Flags'],
        rows: checks.map(ch => [
          ch.check_type.replace(/_/g, ' '),
          ch.status,
          ch.ai_confidence ? ch.ai_confidence + '%' : '-',
          ch.ai_risk_flags.join(', ') || 'None',
        ]),
      },
      { type: 'heading', title: 'Document Verification' },
      {
        type: 'table',
        columns: ['Type', 'File', 'Status'],
        rows: docs.map(d => [d.document_type.replace(/_/g, ' '), d.file_name, d.status]),
      },
      { type: 'heading', title: 'Onboarding Workflows' },
      {
        type: 'table',
        columns: ['Template', 'Status', 'Progress', 'Steps'],
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="toolbar app-region-drag">
        ...
        <div className="flex items-center gap-4 app-region-no-drag">
          <span className="text-[11px] text-white/40">
            <Users className="w-3 h-3 inline mr-1 text-white/25" />
            <span className="font-medium text-white/60">{dash.totalClients}</span> clients
          </span>
          {dash.checksPending > 0 && (
            <span className="text-[11px] text-amber-400">
              <Clock className="w-3 h-3 inline mr-1" />
              {dash.checksPending} pending
            </span>
          )}
          {dash.checksFailed > 0 && (
            <span className="text-[11px] text-red-400">
              <AlertTriangle className="w-3 h-3 inline mr-1" />
              {dash.checksFailed} failed
            </span>
          )}
        </div>
        ...
        <div className="flex items-center gap-1.5 app-region-no-drag">
          {view === 'detail' && (
            <button
              ...
              className="h-6 px-2.5 rounded-[5px] text-[11px] text-white/35 hover:text-white/60 hover:bg-white/[0.04]"
            >
              \u2190 Back
            </button>
          )}{' '}
              ...
              {[
                {
                  l: 'Total Clients',
                  v: dash.totalClients,
                  s: (dash.byStatus.active || 0) + ' active',
                  c: 'text-indigo-400',
                  ic: Users,
                },
                {
                  l: 'Onboarding',
                  v: dash.onboardingActive,
                  s: dash.avgCompletion + '% avg',
                  c: 'text-blue-400',
                  ic: UserCheck,
                },
                {
                  l: 'Pending Checks',
                  v: dash.checksPending,
                  s: dash.checksTotal + ' total',
                  c: dash.checksPending > 0 ? 'text-amber-400' : 'text-emerald-400',
                  ic: Clock,
                },
                {
                  l: 'High Risk',
                  v: (dash.byRisk.high || 0) + (dash.byRisk.pep || 0),
                  s: (dash.byRisk.enhanced || 0) + ' enhanced',
                  c: (dash.byRisk.high || 0) > 0 ? 'text-red-400' : 'text-emerald-400',
                  ic: Shield,
                },
              ].map(card => (
                <div
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-white/[0.06] bg-[#0a0a0a] p-4">
                ...
                <ResponsiveContainer width="100%" height={180}>
                  <PieChart>
                    <Pie
                      data={Object.entries(dash.byRisk)
                        .filter(([, v]) => v > 0)
              ...
              <div className="rounded-xl border border-white/[0.06] bg-[#0a0a0a] p-4">
                ...
                <ResponsiveContainer width="100%" height={180}>
                  <BarChart
                    data={Object.entries(dash.byStatus)
                      .filter(([, v]) => v > 0)
            ...
            <div className="space-y-2">
              ...
              {clients.map(c => (
                <div
                  ...
                  className="group rounded-xl border border-white/[0.06] bg-[#0a0a0a] p-4 hover:border-white/[0.1] transition-all cursor-pointer"
                >
                      ...
                      {c.overall_risk_score != null && (
                        <span
                          className={cn(
                            ...
                            c.overall_risk_score > 70
                              ? 'text-red-400'
                              : c.overall_risk_score > 40
                                ? 'text-amber-400'
                                : 'text-emerald-400'
                          )}
                        >
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  <span
                    className={cn(
                      'text-[10px] px-1.5 py-0.5 rounded capitalize',
                      RISK_BG[selected.risk_rating]
                    )}
                  >
                    {selected.risk_rating}
                  </span>
                  {selected.email && (
                    <span className="text-[11px] text-zinc-600">{selected.email}</span>
                  )}
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={assessRisk}
                  className="h-7 px-3 rounded-lg text-[11px] bg-indigo-600/80 text-white hover:bg-indigo-500 flex items-center gap-1.5"
                >
            ...
            {riskResult && (
              <AIExplainabilityPanel
                ...
                dataSources={[
                  ...
                  'Sanctions Lists (OFSI/EU/UN)',
                  'Jersey Comptroller Records',
                  'Adverse Media Screening',
                ]}
                modelInfo={{
                  name: 'Velanova KYC Risk Engine',
                  version: '2.8.0',
                  type: 'Bayesian Risk Network + Rule-based Scoring',
                }}
              />
            )}
            ...
            <div className="flex items-center gap-1 border-b border-white/[0.06] pb-px">
              {(['checks', 'docs', 'workflow'] as const).map(t => (
                <button
                  ...
                  onClick={() => setTab(t)}
                  className={cn(
                    'px-3 py-1.5 text-[11px] font-medium rounded-t',
              ...
              <div className="space-y-2">
                <div className="flex flex-wrap gap-1.5">
                  {[
                    ...
                    <button
                      key={t}
                      className="h-6 px-2 rounded text-[10px] bg-white/[0.04] text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.06] capitalize"
                    >
                      {t.replace(/_/g, ' ')}
                    </button>
                  ))}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <span className="text-[10px] text-zinc-600 ml-2 capitalize">
      ...
      {showAdd && (
        ...
        >
          <div
            className="bg-[#111] border border-white/[0.08] rounded-xl p-5 w-[420px] space-y-3"
          ...
          >
            ...
            <div className="flex justify-end gap-2">
              <button
                onClick={() => setShowAdd(false)}
                className="h-7 px-3 rounded-md text-[11px] text-zinc-500"
              >
                Cancel
              </button>
              <button
                ...
                className="h-7 px-3 rounded-md text-[11px] font-medium bg-indigo-600 text-white disabled:opacity-30"
              >
                Add
              </button>
            </div>
