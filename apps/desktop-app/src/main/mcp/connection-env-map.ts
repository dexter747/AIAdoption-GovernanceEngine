...
const ENV_MAPS: Record<string, Record<string, string>> = {
  ...
  'infor-cloudsuite': { apiUrl: 'INFOR_API_URL', tokenUrl: 'INFOR_TOKEN_URL', clientId: 'INFOR_CLIENT_ID', clientSecret: 'INFOR_CLIENT_SECRET' },
  'jd-edwards': { aisUrl: 'JDE_AIS_URL', username: 'JDE_USERNAME', password: 'JDE_PASSWORD', environment: 'JDE_ENVIRONMENT' },
  epicor: { url: 'EPICOR_URL', apiKey: 'EPICOR_API_KEY', username: 'EPICOR_USERNAME', password: 'EPICOR_PASSWORD', company: 'EPICOR_COMPANY' },
  'sage-intacct': { senderId: 'INTACCT_SENDER_ID', senderPassword: 'INTACCT_SENDER_PASSWORD', companyId: 'INTACCT_COMPANY_ID', userId: 'INTACCT_USER_ID', userPassword: 'INTACCT_USER_PASSWORD' },
  'oracle-peoplesoft': { url: 'PEOPLESOFT_URL', username: 'PEOPLESOFT_USERNAME', password: 'PEOPLESOFT_PASSWORD' },
  'oracle-opera': { apiUrl: 'OPERA_API_URL', clientId: 'OPERA_CLIENT_ID', clientSecret: 'OPERA_CLIENT_SECRET', propertyId: 'OPERA_PROPERTY_ID' },
  // ── HCM & HR ──
  workday: { tenant: 'WORKDAY_TENANT', username: 'WORKDAY_USERNAME', password: 'WORKDAY_PASSWORD' },
  'sap-successfactors': { apiUrl: 'SF_API_URL', companyId: 'SF_COMPANY_ID', username: 'SF_USERNAME', password: 'SF_PASSWORD' },
  adp: { apiUrl: 'ADP_API_URL', clientId: 'ADP_CLIENT_ID', clientSecret: 'ADP_CLIENT_SECRET', tokenUrl: 'ADP_TOKEN_URL' },
  'ukg-kronos': { apiUrl: 'UKG_API_URL', username: 'UKG_USERNAME', password: 'UKG_PASSWORD', apiKey: 'UKG_API_KEY' },
  ...
  allscripts: { url: 'ALLSCRIPTS_URL', appName: 'ALLSCRIPTS_APP_NAME', appUsername: 'ALLSCRIPTS_APP_USERNAME', appPassword: 'ALLSCRIPTS_APP_PASSWORD' },
  // ── Insurance ──
  guidewire: { pcUrl: 'GUIDEWIRE_PC_URL', ccUrl: 'GUIDEWIRE_CC_URL', bcUrl: 'GUIDEWIRE_BC_URL', accessToken: 'GUIDEWIRE_ACCESS_TOKEN' },
  ...
  // ── Finance & Banking ──
  fis: { apiUrl: 'FIS_API_URL', apiKey: 'FIS_API_KEY', clientId: 'FIS_CLIENT_ID', clientSecret: 'FIS_CLIENT_SECRET' },
  finastra: { apiUrl: 'FINASTRA_API_URL', accessToken: 'FINASTRA_ACCESS_TOKEN' },
  temenos: { apiUrl: 'TEMENOS_API_URL', username: 'TEMENOS_USERNAME', password: 'TEMENOS_PASSWORD' },
  ...
  documentum: { url: 'DOCUMENTUM_URL', username: 'DOCUMENTUM_USERNAME', password: 'DOCUMENTUM_PASSWORD', repository: 'DOCUMENTUM_REPOSITORY' },
  'ibm-filenet': { url: 'FILENET_URL', username: 'FILENET_USERNAME', password: 'FILENET_PASSWORD', objectStore: 'FILENET_OBJECT_STORE' },
  ...
  // ── Education ──
  'ellucian-banner': { apiUrl: 'BANNER_API_URL', apiKey: 'BANNER_API_KEY', username: 'BANNER_USERNAME', password: 'BANNER_PASSWORD' },
  // ── Asset & Facilities ──
  'ibm-maximo': { url: 'MAXIMO_URL', apiKey: 'MAXIMO_API_KEY', username: 'MAXIMO_USERNAME', password: 'MAXIMO_PASSWORD' },
  'ibm-tririga': { url: 'TRIRIGA_URL', username: 'TRIRIGA_USERNAME', password: 'TRIRIGA_PASSWORD' },
  'ge-predix': { apiUrl: 'PREDIX_API_URL', zoneId: 'PREDIX_ZONE_ID', accessToken: 'PREDIX_ACCESS_TOKEN' },
  // ── Procurement ──
  'sap-ariba': { apiUrl: 'ARIBA_API_URL', apiKey: 'ARIBA_API_KEY', realm: 'ARIBA_REALM' },
  coupa: { url: 'COUPA_URL', apiKey: 'COUPA_API_KEY', clientId: 'COUPA_CLIENT_ID', clientSecret: 'COUPA_CLIENT_SECRET' },
  // ── Legacy ──
